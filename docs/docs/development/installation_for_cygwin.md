...
Then `go get -u -v` the following packages:
    ...
    go get -u -v github.com/longXboy/grpc-gateway/v2/protoc-gen-grpc-gateway
    go get -u -v github.com/longXboy/grpc-gateway/v2/protoc-gen-openapiv2
...
This will probably fail with a similar output to this:
    ...
    package github.com/longXboy/grpc-gateway/v2/protoc-gen-grpc-gateway: exit status 128
